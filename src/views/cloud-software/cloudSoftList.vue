<template>
  <div class="content">
    ...
    <p class="title">可行性評估表</p>
    <div class="list-form">
      <!-- 按鈕 -->
      <router-link class="action" to="/feasibility/create">
        <div class="top-btn">
        ...
        <div class="search-row">
          ...
          <el-col :xs="24" :sm="24" :md="12">
            ...
            <div class="search-area">
              ...
              <el-select v-model="state.branchValue" @change="changePersons(state.branchValue)" placeholder="部門" no-data-text="無數據"
                clearable>
              ...
              <el-select v-model="state.personValue" class="ml-1 mr-3" placeholder="人員" no-data-text="請先選部門" clearable>
                <el-option v-for="item in state.personOptions" :key="item.EmpId" :value="item.EmpId" :label="item.EmpName">
                </el-option>
              </el-select>
            </div>
          </el-col>
        ...
        <div class="search-row">
          <el-col :xs="24" :sm="24" :md="6">
            <div class="search-area">
              ...
              <el-select v-model="state.projectNumber" filterable @change="fetchProName(state.projectNumber)" placeholder="請輸入代號"
                no-match-text="無匹配數據" clearable>
